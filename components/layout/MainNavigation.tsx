        ...
        <header className="w-full h-20 bg-[#38015c] shadow-auth flex justify-between items-center py-0 px-[10%]">
            ...
            <nav>
                <ul className="list-none m-0 p-0 flex items-baseline">
                    ...
                    <li className="my-0 mx-4">
                        <button className="font-inherit bg-transparent border border-solid border-white text-white font-bold py-2 px-6 rounded-md cursor-pointer hover:bg-[#c291e2] hover:text-[#38015c]">
                            退出登录
                        </button>
                    </li>
                </ul>
